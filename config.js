const nameGirl = 'Em';
const giftUrl = 'https://www.facebook.com/nghia123z';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc Linh 20/10 tràn ngập niềm vui và những nụ cười. Mong linh luôn xinh đẹp và học giỏi trong hôm nay và cả những ngày sau';
